...
func (s *UserServer) GetAllUsers(ctx context.Context, req *pb.CreateUserRequest) (*pb.CreateUserResponse, error) {
	users, err := s.repo.GetAllUsers(ctx)
	if err != nil {
		return nil, fmt.Errorf("failed to retrieve Users: %v")
	}
}